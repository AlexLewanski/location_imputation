...
ts_upload_path = '/Users/alexlewanski/Documents/michigan_state/research/location_imputation/simulation_output/sim_noadmix/'
output_file_path = '/Users/alexlewanski/Documents/michigan_state/research/location_imputation/simulation_output/sim_noadmix/'
output_tree_path = '/Users/alexlewanski/Documents/michigan_state/research/location_imputation/simulation_output/sim_noadmix/' #tree_dir/'
...
admix_nodes = spatial_ts2_reduced[0].samples(population = 1)

column_names = ['node', 'indiv', 'ped_id', 'p1_ped_id', 'p2_ped_id']

with open(output_file_path + 'admix_node_info.txt', 'w') as file:
    # Write the rows, aligning each list as a column
    file.write("\t".join(column_names) + "\n")
...
for i,tree_pos in enumerate(range(0, spatial_ts2_reduced[0].num_trees, tree_separation)):
...
for TREE in range(0, spatial_ts2_reduced[0].num_trees, tree_separation):
    with open(output_tree_path +  "spatial_sim" + str(TREE) + ".nwk", "w") as f:
