tree_list <- lapply(list.files('/Users/alexlewanski/Documents/michigan_state/research/tmp/tree_dir', full.names = TRUE),
                    function(x) ape::read.tree(x)) 

indiv_node_info <- read.delim('/Users/alexlewanski/Documents/michigan_state/research/tmp/indiv_node_info.txt',
                              header = TRUE)
indiv_node_info$n_node <- paste0('n', indiv_node_info$node)

tree_position_info <- read.delim('/Users/alexlewanski/Documents/michigan_state/research/tmp/tree_position_info.txt',
                                 header = TRUE)
